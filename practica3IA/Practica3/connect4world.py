from Tkinter import *
import tkMessageBox
from connect4game import Connect4Game, eval_board1, eval_board2
...
if __name__ == "__main__":
	f=open("pruebasab.txt","w");
	f.write("Comienzo pruebas alpha beta\n");
	f=open("pruebasmm.txt","w");
	f.write("Comienzo pruebas minimax\n");
	random_player = RandomPlayer()
	minimax_player = MinimaxPlayer(3)
	alphabeta_player = AlphabetaPlayer(4, eval_board1)
	alphabeta_player2 = AlphabetaPlayer(4, eval_board2)
	world = Connect4World(6, 7, player1=alphabeta_player, player2=alphabeta_player2)
